...
## Switches
#set_property PACKAGE_PIN V17 [get_ports {MEASURE}]
...
set_property PACKAGE_PIN P3 [get_ports {action[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {action[0]}]
set_property PACKAGE_PIN N3 [get_ports {action[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {action[1]}]
set_property PACKAGE_PIN P1 [get_ports {action[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {action[2]}]
set_property PACKAGE_PIN L1 [get_ports {action[3]}]
...
#set_property PACKAGE_PIN T18 [get_ports press]
...
##Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {SOUND}]
